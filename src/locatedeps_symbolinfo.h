#ifndef LOCATE_DEPS_SYMBOLINFO_H
#define LOCATE_DEPS_SYMBOLINFO_H
...
private:
    ...
    /// \brief Contains information about symbol contexts. Context information
    /// is stored from the inner-most level to outer-most level.
    ///
